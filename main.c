...
"\n"
"  Commands:\n"
"    train CLASS < KNOWN     Train email, classification is CLASS\n"
"    classify < UNKNOWN      Output best class and confidence estimate\n"
"    annotate < UNKNOWN      As \"classify\" but copy input email to stdout\n"
"                            adding an \"X-Bfilter-Class:\" header\n"
"    untrain OLD < PREVIOUS  Undo a previous training\n"
"    retrain OLD NEW < PREV  Same as \"untrain OLD\" then \"train NEW\"\n"
"    move OLD NEW            Rename a class\n"
"\n"
"  Flags:\n"
